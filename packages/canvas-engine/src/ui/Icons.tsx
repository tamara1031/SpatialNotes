...
export const PrecisionEraserIcon = memo<IconProps>(
	({ size = 18, color = "currentColor", strokeWidth = 1.8 }) => (
		<svg
			width={size}
			height={size}
...
export const PickerIcon: React.FC<IconProps> = ({
	size = 20,
	color = "currentColor",
}) => (
	<svg
...
export const BringToFrontIcon: React.FC<IconProps> = ({
	size = 20,
	color = "currentColor",
	strokeWidth = 1.8,
}) => (
	...
	>
		...
		<path d="M4 10a2 2 0 0 1 2-2h10" strokeOpacity="0.3" />
		<path
			d="M10 4a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2h-2"
			strokeOpacity="0.3"
		/>
	</svg>
);

export const SendToBackIcon = memo<IconProps>(
	({ size = 18, color = "currentColor", strokeWidth = 1.8 }) => (
		<svg
			width={size}
			height={size}
			...
			strokeLinejoin="round"
		>
			<rect x="4" y="4" width="12" height="12" rx="2" strokeOpacity="0.3" />
			<path d="M14 8h6a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H10a2 2 0 0 1-2-2v-6" />
		</svg>
	),
);
